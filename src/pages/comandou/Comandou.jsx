...
const Header = ({ logo, activeTab, setActiveTab, theme, toggleTheme, user, onLogout, onLogoClick, isMobile }) => {
  return (
      ...
      <div className="header-right-comandou">
        ...
        {user ? (
          <div className="user-menu-cm">
            <FaUser />
            {!isMobile && <span className="user-email">{user}</span>}
...
const LoginComandou = ({ onLogin, isMobile }) => {
  ...
  const handleSubmitComandou = (e) => {
    ...
    if (loginComandouEmail === 'nextiscontato@gmail.com' && loginComandouSenha === 'nextis') {
      ...
      onLogin(true, loginComandouEmail);
    } else {
  ...
  return (
    <div className="login-comandou-container">
      <div className="comandou-login-header">
        <img src="/images/logo-comandou.png" alt="Comandou" />
...
const ComandaTab = ({ pedidos, onPedidoPronto, onLogout, estoque, isMobile }) => {
...
const GerenciamentoTab = ({ cardapio, estoque, onAtualizarCardapio, onAtualizarEstoque, isMobile }) => {
...
const CardapioTab = ({ onAdicionarPedido, pedidoPronto, pedidos, pedidosEmPreparo, estoque, cardapio, isMobile }) => {
  ...
  const categorias = [
    ...
    { id: 'vinho', nome: 'Vinhos' },
    { id: 'destilado', nome: 'Destilados' },
    { id: 'cerveja', nome: 'Cervejas' },
    { id: 'espumante', nome: 'Espumantes' },
    { id: 'licor', nome: 'Licores' },
    { id: 'agua', nome: 'Águas' },
    { id: 'chopp', nome: 'Chopp' },
    { id: 'petisco', nome: 'Petiscos' },
    { id: 'porcao', nome: 'Porções' }
  ];
      ...
      <div className="cardapio-container">
        <div className="itens-cardapio">
          <div className="scroll-controls">
            <button
              className={`scroll-btn scroll-left ${!showLeftArrow ? 'hidden' : ''}`}
              onClick={scrollLeft}
            >
              <FaArrowLeft />
            </button>
            <button
              className={`scroll-btn scroll-right ${!showRightArrow ? 'hidden' : ''}`}
              onClick={scrollRight}
            >
              <FaArrowRight />
            </button>
